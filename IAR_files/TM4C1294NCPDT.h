...
void HIB_IRQHandler(void);              
void USB0_IRQHandler(void);             
void PWM0_3_IRQHandler(void);           
void UDMA_IRQHandler(void);             
void UDMAERR_IRQHandler(void);          
void ADC1SS0_IRQHandler(void);          
void ADC1SS1_IRQHandler(void);          
...
void GPIOP4_IRQHandler(void);           
void GPIOP5_IRQHandler(void);           
void GPIOP6_IRQHandler(void);           
void GPIOP7_IRQHandler(void);           
void GPIOQ0_IRQHandler(void);           
void GPIOQ1_IRQHandler(void);           
void GPIOQ2_IRQHandler(void);           
void GPIOQ3_IRQHandler(void);           
void GPIOQ4_IRQHandler(void);           
void GPIOQ5_IRQHandler(void);           
void GPIOQ6_IRQHandler(void);           
void GPIOQ7_IRQHandler(void);           
void TIMER6A_IRQHandler(void);          
void TIMER6B_IRQHandler(void);          
void TIMER7A_IRQHandler(void);          
void TIMER7B_IRQHandler(void);          
